...
namespace PleaseTests
{
    [CheckpointPath("test/bin/checkpoints/contract-deployed.neoxp-checkpoint")]
    public class PleaseContractTests : IClassFixture<CheckpointFixture<PleaseContractTests>>
    {
        ...
        public PleaseContractTests(CheckpointFixture<PleaseContractTests> fixture)
        {
        ...
        public void contract_owner_in_storage()
        {
            ...
            var storages = snapshot.GetContractStorages<PleaseContract>();
        ...
        public void can_change_number()
        {
            ...
            engine.ExecuteScript<PleaseContract>(c => c.changeNumber(42));
