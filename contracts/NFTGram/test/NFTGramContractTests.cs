...
namespace HelloWorldTests
{
    ...
    public class HelloWorldContractTests : IClassFixture<CheckpointFixture<HelloWorldContractTests>>
    {
        ...
        public HelloWorldContractTests(CheckpointFixture<HelloWorldContractTests> fixture)
        {
        ...
        public void contract_owner_in_storage()
        {
            ...
            var storages = snapshot.GetContractStorages<HelloWorldContract>();
        ...
        public void can_change_number()
        {
            ...
            engine.ExecuteScript<HelloWorldContract>(c => c.changeNumber(42));
