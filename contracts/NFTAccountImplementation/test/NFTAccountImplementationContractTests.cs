...
namespace WaitTests
{
    ...
    public class WaitContractTests : IClassFixture<CheckpointFixture<WaitContractTests>>
    {
        ...
        public WaitContractTests(CheckpointFixture<WaitContractTests> fixture)
        {
        ...
        public void contract_owner_in_storage()
        {
            ...
            var storages = snapshot.GetContractStorages<WaitContract>();
        ...
        public void can_change_number()
        {
            ...
            engine.ExecuteScript<WaitContract>(c => c.changeNumber(42));
