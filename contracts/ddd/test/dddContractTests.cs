...
namespace dddTests
{
    ...
    public class dddContractTests : IClassFixture<CheckpointFixture<dddContractTests>>
    {
        ...
        public dddContractTests(CheckpointFixture<dddContractTests> fixture)
        {
        ...
        public void contract_owner_in_storage()
        {
            ...
            var storages = snapshot.GetContractStorages<dddContract>();
        ...
        public void can_change_number()
        {
            ...
            engine.ExecuteScript<dddContract>(c => c.changeNumber(42));
