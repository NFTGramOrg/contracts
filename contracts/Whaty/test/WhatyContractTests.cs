...
namespace WhatyTests
{
    [CheckpointPath("test/bin/checkpoints/contract-deployed.neoxp-checkpoint")]
    public class WhatyContractTests : IClassFixture<CheckpointFixture<WhatyContractTests>>
    {
        ...
        public WhatyContractTests(CheckpointFixture<WhatyContractTests> fixture)
        {
        ...
        public void contract_owner_in_storage()
        {
            ...
            var storages = snapshot.GetContractStorages<WhatyContract>();
        ...
        public void can_change_number()
        {
            ...
            engine.ExecuteScript<WhatyContract>(c => c.changeNumber(42));
