...
namespace ProblemTests
{
    ...
    public class ProblemContractTests : IClassFixture<CheckpointFixture<ProblemContractTests>>
    {
        ...
        public ProblemContractTests(CheckpointFixture<ProblemContractTests> fixture)
        {
        ...
        public void contract_owner_in_storage()
        {
            ...
            var storages = snapshot.GetContractStorages<ProblemContract>();
        ...
        public void can_change_number()
        {
            ...
            engine.ExecuteScript<ProblemContract>(c => c.changeNumber(42));
